...
А теперь вспоминаем категорию таска. Это **PPC**, а значит это таск, подобный таску **Я не плачу - это просто лук**, а значит надо много раз декодировать Base64, пока на получим флаг.
